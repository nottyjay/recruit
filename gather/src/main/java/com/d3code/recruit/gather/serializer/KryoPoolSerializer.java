...
public class KryoPoolSerializer implements Serializer {
    ...
    public byte[] serialize(Object obj) throws IOException {
        ...
        if (obj == null) throw new GatherException("obj can not be null");
        try {
            ...
            throw new GatherException("Serialize obj exception");
        } finally {
    ...
    public Object deserialize(byte[] bytes) throws IOException {
        KryoHolder kryoHolder = null;
        if (bytes == null) throw new GatherException("bytes can not be null");
        try {
            kryoHolder = KryoPoolImpl.getInstance().get();
            ...
            throw new GatherException("Deserialize bytes exception");
        } finally {
            KryoPoolImpl.getInstance().offer(kryoHolder);
            bytes = null;       //  for gc
        }
